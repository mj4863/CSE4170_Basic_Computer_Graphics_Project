...
enum STATIC_OBJECT_ID {
	...
	STATIC_OBJECT_BIKE, STATIC_OBJECT_ANT, STATIC_OBJECT_DRAGON,
	STATIC_OBJECT_IRONMAN, STATIC_OBJECT_WOODTOWER, STATIC_OBJECT_CAT
};

enum DYNAMIC_OBJECT_ID {
	DYNAMIC_OBJECT_TIGER = 0, DYNAMIC_OBJECT_COW_1, DYNAMIC_OBJECT_COW_2, DYNAMIC_OBJECT_WOLF
};
...
struct WoodTower : public Static_Object {
	WoodTower(STATIC_OBJECT_ID _object_id) : Static_Object(_object_id) {}
	void define_object();
};
...
struct Static_Geometry_Data {
	...
	WoodTower woodTower{ STATIC_OBJECT_WOODTOWER };
...
struct Scene {
	...
	Camera_ID currentDrawingCamera;
	...
	void draw_axis();
	void draw_world();
	void draw_camera_frame(const Camera& cam);
};
